...
import com.bikefactory.exception.CustomerTableEmptyException;
...
public class SaveCustomerServiceImpl implements SaveCustomerService{
    ...
    public void insertNewCustomer(SaveOrUpdateCustomerRequestDto saveOrUpdateCustomerRequestDto) {
        ...
        Customer lastInserted = customerRepository.findFirstByOrderByCustomerIdDesc().orElseThrow(CustomerTableEmptyException::new);
